...
<recipetype:farmersdelight:cooking>.addRecipe("farmersdelight_cooking_pot/croptopia/chimichanga", <item:croptopia:chimichanga>, [<item:croptopia:burrito>, <tag:items:forge:flours>], rbMisc, <item:minecraft:air>, 1, 200);
<recipetype:farmersdelight:cooking>.addRecipe("farmersdelight_cooking_pot/croptopia/chocolate", <item:croptopia:chocolate>, [<item:croptopia:cocoa_beans>, <item:croptopia:butter>], rbMisc, <item:minecraft:air>, 1, 260);
