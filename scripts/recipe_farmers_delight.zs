...
<recipetype:farmersdelight:cutting>.addRecipe("farmersdelight_cutting/aquaculturedelight/fillet_four", <tag:items:aquaculturedelight:fillet_four>, [<item:aquaculture:fish_fillet_raw> * 4, <item:minecraft:bone_meal>, <item:aquaculture:fish_bones> % 5], <tag:items:farmersdelight:tools/fillet_knife>);
<recipetype:farmersdelight:cutting>.removeByName("aquaculturedelight:cutting/knife/fillet_fourteen");
<recipetype:farmersdelight:cutting>.addRecipe("farmersdelight_cutting/aquaculturedelight/fillet_fourteen", <tag:items:aquaculturedelight:fillet_fourteen>, [<item:aquaculture:fish_fillet_raw> * 14, <item:minecraft:bone_meal>, <item:aquaculture:fish_bones> % 5], <tag:items:farmersdelight:tools/fillet_knife>);
<recipetype:farmersdelight:cutting>.removeByName("aquaculturedelight:cutting/knife/fillet_one");
<recipetype:farmersdelight:cutting>.addRecipe("farmersdelight_cutting/aquaculturedelight/fillet_one", <tag:items:aquaculturedelight:fillet_one>, [<item:aquaculture:fish_fillet_raw>, <item:minecraft:bone_meal>, <item:aquaculture:fish_bones> % 5], <tag:items:farmersdelight:tools/fillet_knife>);
<recipetype:farmersdelight:cutting>.removeByName("aquaculturedelight:cutting/knife/fillet_six");
<recipetype:farmersdelight:cutting>.addRecipe("farmersdelight_cutting/aquaculturedelight/fillet_six", <tag:items:aquaculturedelight:fillet_six>, [<item:aquaculture:fish_fillet_raw> * 6, <item:minecraft:bone_meal>, <item:aquaculture:fish_bones> % 5], <tag:items:farmersdelight:tools/fillet_knife>);
<recipetype:farmersdelight:cutting>.removeByName("aquaculturedelight:cutting/knife/fillet_ten");
<recipetype:farmersdelight:cutting>.addRecipe("farmersdelight_cutting/aquaculturedelight/fillet_ten", <tag:items:aquaculturedelight:fillet_ten>, [<item:aquaculture:fish_fillet_raw> * 10, <item:minecraft:bone_meal>, <item:aquaculture:fish_bones> % 5], <tag:items:farmersdelight:tools/fillet_knife>);
<recipetype:farmersdelight:cutting>.removeByName("aquaculturedelight:cutting/knife/fillet_three");
<recipetype:farmersdelight:cutting>.addRecipe("farmersdelight_cutting/aquaculturedelight/fillet_three", <tag:items:aquaculturedelight:fillet_three>, [<item:aquaculture:fish_fillet_raw> * 3, <item:minecraft:bone_meal>, <item:aquaculture:fish_bones> % 5], <tag:items:farmersdelight:tools/fillet_knife>);
<recipetype:farmersdelight:cutting>.removeByName("aquaculturedelight:cutting/knife/fillet_twelve");
<recipetype:farmersdelight:cutting>.addRecipe("farmersdelight_cutting/aquaculturedelight/fillet_twelve", <tag:items:aquaculturedelight:fillet_twelve>, [<item:aquaculture:fish_fillet_raw> * 12, <item:minecraft:bone_meal>, <item:aquaculture:fish_bones> % 5], <tag:items:farmersdelight:tools/fillet_knife>);
<recipetype:farmersdelight:cutting>.removeByName("aquaculturedelight:cutting/knife/fillet_two");
<recipetype:farmersdelight:cutting>.addRecipe("farmersdelight_cutting/aquaculturedelight/fillet_two", <tag:items:aquaculturedelight:fillet_two>, [<item:aquaculture:fish_fillet_raw> * 2, <item:minecraft:bone_meal>, <item:aquaculture:fish_bones> % 5], <tag:items:farmersdelight:tools/fillet_knife>);
