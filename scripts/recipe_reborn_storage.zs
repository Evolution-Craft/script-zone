...
craftingTable.addShapeless("rebornstorage_parts_raw_super_advanced_processor", <item:rebornstorage:raw_super_advanced_processor>, [<item:refinedstorage:processor_binding>, <item:minecraft:netherite_ingot>, <tag:items:forge:silicon>, <item:minecraft:redstone>]);

craftingTable.removeByName("rebornstorage:multiblock_heat");
craftingTable.addShaped("rebornstorage_multiblock_heat", <item:rebornstorage:multiblock_heat>, [
...
craftingTable.addShaped("rebornstorage_multiblock_frame", <item:rebornstorage:multiblock_frame> * 6, [
