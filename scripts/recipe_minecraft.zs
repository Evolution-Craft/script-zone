...
blastFurnace.addRecipe("blast_furnace/aquaculture/neptunium_fillet_knife", <item:aquaculture:neptunium_nugget>, <item:aquaculture:neptunium_fillet_knife>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/aquaculturedelight/neptunium_knife", <item:aquaculture:neptunium_nugget>, <item:aquaculturedelight:neptunium_knife>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/contenttweaker/copper_knife", <item:thermal:copper_nugget>, <item:contenttweaker:evolution_craft/knife/copper_knife>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/contenttweaker/steel_knife", <item:thermal:steel_nugget>, <item:contenttweaker:evolution_craft/knife/steel_knife>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/create/charged_crushed_certus_quartz", <item:ae2:charged_certus_quartz_crystal>, <item:contenttweaker:ae2/crushed_charged_certus_quartz>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/create/crushed_certus_quartz", <item:ae2:certus_quartz_crystal>, <item:contenttweaker:ae2/crushed_certus_quartz>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/create/crushed_cobalt_ore", <item:tconstruct:cobalt_ingot>, <item:contenttweaker:tconstruct/crushed_cobalt_ore>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/create/crushed_fluix", <item:ae2:fluix_crystal>, <item:contenttweaker:ae2/crushed_fluix>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/create/crushed_hepatizon", <item:tconstruct:hepatizon_ingot>, <item:contenttweaker:tconstruct/crushed_hepatizon>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/create/crushed_manyullyn", <item:tconstruct:manyullyn_ingot>, <item:contenttweaker:tconstruct/crushed_manyullyn>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/create/crushed_quartz", <item:minecraft:quartz>, <item:contenttweaker:ae2/crushed_quartz>, 0.1, 100);
...
blastFurnace.addRecipe("blast_furnace/croptopia/frying_pan", <item:minecraft:iron_ingot>, <item:croptopia:frying_pan>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/croptopia/knife", <item:minecraft:iron_ingot>, <item:croptopia:knife>, 0.1, 100);
...
blastFurnace.addRecipe("blast_furnace/exlinecopperequipment/copper_boots", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_boots>, 0.1, 100);
blastFurnace.removeByName("exlinecopperequipment:copper_chest_blast");
blastFurnace.addRecipe("blast_furnace/exlinecopperequipment/copper_chestplate", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_chestplate>, 0.1, 100);
blastFurnace.removeByName("exlinecopperequipment:copper_helm_blast");
blastFurnace.addRecipe("blast_furnace/exlinecopperequipment/copper_helmet", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_helmet>, 0.1, 100);
blastFurnace.removeByName("exlinecopperequipment:copper_horse_armor_blast");
blastFurnace.addRecipe("blast_furnace/exlinecopperequipment/copper_horse_armor", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_horse_armor>, 0.1, 100);
blastFurnace.removeByName("exlinecopperequipment:copper_leggs_blast");
blastFurnace.addRecipe("blast_furnace/exlinecopperequipment/copper_leggings", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_leggings>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/farmersdelight/netherite_knife", <item:thermal:netherite_nugget>, <item:farmersdelight:netherite_knife>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/galosphere/sterling_boots", <item:thermal:silver_nugget>, <item:galosphere:sterling_boots>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/galosphere/sterling_chestplate", <item:thermal:silver_nugget>, <item:galosphere:sterling_chestplate>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/galosphere/sterling_helmet", <item:thermal:silver_nugget>, <item:galosphere:sterling_helmet>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/galosphere/sterling_horse_armor", <item:thermal:silver_nugget>, <item:galosphere:sterling_horse_armor>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/galosphere/sterling_leggings", <item:thermal:silver_nugget>, <item:galosphere:sterling_leggings>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/galosphere/delight_silver_knife", <item:thermal:silver_nugget>, <item:galosphere_delight:silver_knife>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/infernalexp/silt", <item:minecraft:glass>, <item:infernalexp:silt>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/mekanism/ingot_refined_glowstone_from_crushed_refined_glowstone", <item:mekanism:ingot_refined_glowstone>, <item:contenttweaker:mekanism/crushed_refined_glowstone>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/mekanism/ingot_refined_obsidian_from_crushed_refined_obsidian", <item:mekanism:ingot_refined_obsidian>, <item:contenttweaker:mekanism/crushed_refined_obsidian>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/minecraft/clay", <item:minecraft:terracotta>, <item:minecraft:clay>, 0.35, 100);
...
blastFurnace.addRecipe("blast_furnace/minecraft/sand", <item:minecraft:glass>, <tag:items:minecraft:sand>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/minecraft/stone", <item:minecraft:smooth_stone>, <item:minecraft:stone>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/nha/netherite_horse_armor", <item:thermal:netherite_nugget>, <item:nha:netherite_horse_armor>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/tconstruct/ingot_pig_iron_from_crushed_pig_iron", <item:tconstruct:pig_iron_ingot>, <item:contenttweaker:tconstruct/crushed_pig_iron>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/quark/dirty_glass", <item:minecraft:glass>, <item:quark:dirty_glass>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/thermal/steel_ingot_from_crushed_steel", <item:thermal:steel_ingot>, <item:contenttweaker:mekanism/crushed_steel>, 0.1, 100);
blastFurnace.removeByName("undergarden:blast_froststeel_item");
blastFurnace.addRecipe("blast_furnace/undergarden/blast_froststeel_item", <item:undergarden:froststeel_nugget>, <tag:items:undergarden:froststeel_items>, 0.1, 100);
blastFurnace.addRecipe("blast_furnace/undergarden/raw_cloggrum_block", <item:undergarden:cloggrum_block>, <item:undergarden:raw_cloggrum_block>, 6.0, 200);
blastFurnace.addRecipe("blast_furnace/undergarden/raw_froststeel_block", <item:undergarden:froststeel_block>, <item:undergarden:raw_froststeel_block>, 6.0, 200);
...
furnace.addRecipe("furnace/alexsmobs/fish_bones", <item:minecraft:bone_meal> * 3, <item:alexsmobs:fish_bones>, 0.05, 200);
...
furnace.addRecipe("furnace/create/crushed_certus_quartz", <item:ae2:certus_quartz_crystal>, <item:contenttweaker:ae2/crushed_certus_quartz>, 0.1, 200);
furnace.addRecipe("furnace/create/crushed_cobalt_ore", <item:tconstruct:cobalt_ingot>, <item:contenttweaker:tconstruct/crushed_cobalt_ore>, 0.1, 200);
furnace.addRecipe("furnace/create/crushed_fluix", <item:ae2:fluix_crystal>, <item:contenttweaker:ae2/crushed_fluix>, 0.1, 200);
furnace.addRecipe("furnace/create/crushed_hepatizon", <item:tconstruct:hepatizon_ingot>, <item:contenttweaker:tconstruct/crushed_hepatizon>, 0.1, 200);
furnace.addRecipe("furnace/create/crushed_manyullyn", <item:tconstruct:manyullyn_ingot>, <item:contenttweaker:tconstruct/crushed_manyullyn>, 0.1, 200);
furnace.addRecipe("furnace/create/crushed_quartz", <item:minecraft:quartz>, <item:contenttweaker:ae2/crushed_quartz>, 0.1, 200);
...
furnace.addRecipe("furnace/croptopia/food_press", <item:minecraft:iron_ingot>, <item:croptopia:food_press>, 0.1, 200);
furnace.addRecipe("furnace/croptopia/frying_pan", <item:minecraft:iron_ingot>, <item:croptopia:frying_pan>, 0.1, 200);
furnace.addRecipe("furnace/croptopia/knife", <item:minecraft:iron_ingot>, <item:croptopia:knife>, 0.1, 200);
furnace.addRecipe("furnace/enlightened/end_adamantite_knife", <item:enlightened_end:adamantite_nugget>, <item:enlightened_end:adamantite_knife>, 0.1, 200);
furnace.removeByName("exlinecopperequipment:copper_boots_smelt");
furnace.addRecipe("furnace/exlinecopperequipment/copper_boots", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_boots>, 0.1, 200);
furnace.removeByName("exlinecopperequipment:copper_chest_smelt");
furnace.addRecipe("furnace/exlinecopperequipment/copper_chestplate", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_chestplate>, 0.1, 200);
furnace.removeByName("exlinecopperequipment:copper_helm_smelt");
furnace.addRecipe("furnace/exlinecopperequipment/copper_helmet", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_helmet>, 0.1, 200);
furnace.removeByName("exlinecopperequipment:copper_horse_armor_smelt");
furnace.addRecipe("furnace/exlinecopperequipment/copper_horse_armor", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_horse_armor>, 0.1, 200);
furnace.removeByName("exlinecopperequipment:copper_leggs_smelt");
furnace.addRecipe("furnace/exlinecopperequipment/copper_leggings", <item:thermal:copper_nugget>, <item:exlinecopperequipment:copper_leggings>, 0.1, 200);
furnace.addRecipe("furnace/farmersdelight/netherite_knife", <item:thermal:netherite_nugget>, <item:farmersdelight:netherite_knife>, 0.1, 200);
furnace.addRecipe("furnace/galosphere/sterling_boots", <item:thermal:silver_nugget>, <item:galosphere:sterling_boots>, 0.1, 200);
furnace.addRecipe("furnace/galosphere/sterling_chestplate", <item:thermal:silver_nugget>, <item:galosphere:sterling_chestplate>, 0.1, 200);
furnace.addRecipe("furnace/galosphere/sterling_helmet", <item:thermal:silver_nugget>, <item:galosphere:sterling_helmet>, 0.1, 200);
furnace.addRecipe("furnace/galosphere/sterling_horse_armor", <item:thermal:silver_nugget>, <item:galosphere:sterling_horse_armor>, 0.1, 200);
furnace.addRecipe("furnace/galosphere/sterling_leggings", <item:thermal:silver_nugget>, <item:galosphere:sterling_leggings>, 0.1, 200);
furnace.addRecipe("furnace/galosphere/delight_silver_knife", <item:thermal:silver_nugget>, <item:galosphere_delight:silver_knife>, 0.1, 200);
furnace.addRecipe("furnace/mekanism/ingot_refined_glowstone_from_crushed_refined_glowstone", <item:mekanism:ingot_refined_glowstone>, <item:contenttweaker:mekanism/crushed_refined_glowstone>, 0.1, 200);
furnace.addRecipe("furnace/mekanism/ingot_refined_obsidian_from_crushed_refined_obsidian", <item:mekanism:ingot_refined_obsidian>, <item:contenttweaker:mekanism/crushed_refined_obsidian>, 0.1, 200);
furnace.addRecipe("furnace/minecraft/beetroot", <item:minecraft:sugar> * 2, <item:minecraft:beetroot>, 0.1, 60);
furnace.addRecipe("furnace/minecraft/rotten_flesh", <item:minecraft:leather>, <item:minecraft:rotten_flesh> * 4, 0.4, 240);
furnace.addRecipe("furnace/nha/netherite_horse_armor", <item:thermal:netherite_nugget>, <item:nha:netherite_horse_armor>, 0.1, 200);
furnace.addRecipe("furnace/netherdepthsupgrade/bonefish", <item:minecraft:bone_meal> * 3, <item:netherdepthsupgrade:bonefish>, 0.05, 200);
furnace.addRecipe("furnace/thermal/steel_ingot_from_crushed_steel", <item:thermal:steel_ingot>, <item:contenttweaker:mekanism/crushed_steel>, 0.1, 200);
furnace.addRecipe("furnace/tconstruct/ingot_pig_iron_from_crushed_pig_iron", <item:tconstruct:pig_iron_ingot>, <item:contenttweaker:tconstruct/crushed_pig_iron>, 0.1, 200);
furnace.addRecipe("furnace/twilightforest/green_thorns", <item:twilightforest:burnt_thorns>, <item:twilightforest:green_thorns>, 0.4, 240);
furnace.addRecipe("furnace/twilightforest/brown_thorns", <item:twilightforest:burnt_thorns>, <item:twilightforest:brown_thorns>, 0.4, 240);
furnace.removeByName("undergarden:smelt_froststeel_item");
furnace.addRecipe("furnace/undergarden/smelt_froststeel_item", <item:undergarden:froststeel_nugget>, <tag:items:undergarden:froststeel_items>, 0.1, 200);
furnace.addRecipe("furnace/vinery/dought", <item:vinery:crusty_bread>, <item:vinery:dough>, 0.35, 200);
